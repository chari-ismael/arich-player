  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(children: [
      ...
      Flexible(child: Text(label, style: GoogleFonts.inter(
          ...
          fontWeight: FontWeight.w700, letterSpacing: 0.8), overflow: TextOverflow.ellipsis)),
    ]),
  );
}
          ...
          FocusableInk(
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 12),
                Flexible(child: Text(context.read<LanguageProvider>().l10n.t('downloads_delete'), style: GoogleFonts.inter(
