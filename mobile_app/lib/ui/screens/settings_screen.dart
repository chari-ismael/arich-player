...
class _MobileLayout extends StatefulWidget {
  ...
  @override State<_MobileLayout> createState() => _MobileLayoutState();
}
...
class _MobileLayoutState extends State<_MobileLayout>
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      Padding(
        padding: EdgeInsets.fromLTRB(10, MediaQuery.paddingOf(context).top + 8, 10, 8),
        child: Row(children: [
          FocusableInk(
            onTap: () => Navigator.maybePop(context),
            borderRadius: 10,
          ...
          const SizedBox(width: 12),
          Expanded(child: Text(l.t('settings_title'), style: GoogleFonts.rajdhani(
          ...
          itemBuilder: (_, i) {
            ...
            return Padding(
              ...
              child: GestureDetector(
                onTap: () => widget.onSelect(sec),
                child: AnimatedContainer(
                  duration: const Duration(milliseconds: 180),
                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                  decoration: BoxDecoration(
                    color: on ? sec.color.withOpacity(0.18) : Colors.white.withOpacity(0.05),
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(color: on
                        ? sec.color.withOpacity(0.4) : Colors.white.withOpacity(0.08)),
                  ),
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    Icon(sec.icon, size: 14, color: on ? sec.color : Colors.white38),
                    const SizedBox(width: 6),
                    Text(sec.label(l), style: TextStyle(
      ...
      Expanded(child: SingleChildScrollView(
        ...
        child: KeyedSubtree(key: ValueKey(active), child: widget.content),
      )),
    ]);
  }
}
...
class _ProfileSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisSize: MainAxisSize.min,
      ...
      _SectionHeader(sec: _Sec.profile, l: l),
...
class _PlaylistsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      _SectionHeader(sec: _Sec.playlists, l: l),
      const SizedBox(height: 16),
...
class _DisplaySection extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ValueListenableBuilder(
    ...
    builder: (context, box, _) => Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      _SectionHeader(sec: _Sec.display, l: l),
      const SizedBox(height: 16),
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, box, _) => Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        _SectionHeader(sec: _Sec.preferences, l: l),
        const SizedBox(height: 16),
...
class _AccountSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      _SectionHeader(sec: _Sec.account, l: l),
      const SizedBox(height: 16),
      if (user != null) ...[
...
class _SupportSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    mainAxisSize: MainAxisSize.min,
    crossAxisAlignment: CrossAxisAlignment.stretch, children: [
    _SectionHeader(sec: _Sec.support, l: l),
    const SizedBox(height: 16),
...
class _DataSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ValueListenableBuilder(
    ...
    builder: (context, box, _) => Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      _SectionHeader(sec: _Sec.data, l: l),
      const SizedBox(height: 16),
