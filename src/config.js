...
export const downloadLinks = {
  ...
  windows: `https://github.com/${RELEASE_REPO}/releases/download/v${APP_VERSION}/ArichPlayer-v${APP_VERSION}-Setup.exe`,
  googlePlay: 'https://play.google.com/store/apps/details?id=com.arich.iptv',
  qrTarget: 'https://arich.fr/download',
}
...
export const LINKS = {
  ...
  download: 'https://arich.fr/download',
  auth: '/auth.html',
