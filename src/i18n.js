const dict = {
  fr: {
    ...
    price_over: 'Tarifs',
    price_title: 'Simple. Transparent.',
    price_sub: '14 jours gratuits. Aucun contenu fourni — licence application uniquement.',
    price_trial: 'jours gratuits',
    price_year_t: 'Annuel',
    price_year_b: 'Renouvellement simple. Accès complet.',
    price_life_t: 'À vie',
    price_life_b: 'Un paiement. Pour toujours.',
    price_reco: 'Recommandé',
    price_cta: 'Activer',
    price_note: 'Licence app · aucun contenu fourni.',

    faq_over: 'FAQ',
    faq_title: 'Questions fréquentes',
    faq_sub: 'Les réponses essentielles, sans jargon.',
    faq_1_q: 'ARICH fournit-il des contenus ?',
    faq_1_a: 'Non. ARICH est un lecteur. Vous connectez vos propres accès Xtream ou playlists M3U.',
    faq_2_q: 'Comment fonctionne l’essai gratuit ?',
    faq_2_a: '14 jours pour tester l’application. Ensuite, choisissez l’offre annuelle ou à vie.',
    faq_3_q: 'Sur quels appareils ?',
    faq_3_a: 'Android et Android TV. Téléchargez l’APK ou via Google Play lorsque disponible.',
    faq_4_q: 'Puis-je regarder hors ligne ?',
    faq_4_a: 'Oui, via le téléchargement local sur l’appareil — selon les contenus de votre playlist.',
    faq_5_q: 'C’est quoi Watch Together ?',
    faq_5_a: 'Une lecture synchronisée à distance : vous regardez le même flux, au même moment.',
    faq_6_q: 'Comment vous contacter ?',
    faq_6_a: 'Utilisez le formulaire ci-dessous, ou écrivez à contact@arich.fr.',

    contact_over: 'Contact',
    contact_title: 'Écrivez-nous',
    contact_sub: 'Une question, un bug, un retour — on lit tout.',
    contact_name: 'Nom',
    contact_email: 'Email',
    contact_subject: 'Sujet',
    contact_message: 'Message',
    contact_send: 'Envoyer',
    contact_ok: 'Ouverture de votre client mail…',
  ...
  en: {
    ...
    price_over: 'Pricing',
    price_title: 'Simple. Transparent.',
    price_sub: '14-day free trial. No content included — app license only.',
    price_trial: 'free days',
    price_year_t: 'Yearly',
    price_year_b: 'Simple renewal. Full access.',
    price_life_t: 'Lifetime',
    price_life_b: 'One payment. Forever.',
    price_reco: 'Recommended',
    price_cta: 'Activate',
    price_note: 'App license · no content included.',

    faq_over: 'FAQ',
    faq_title: 'Frequently asked questions',
    faq_sub: 'The essentials, without the jargon.',
    faq_1_q: 'Does ARICH provide content?',
    faq_1_a: 'No. ARICH is a player. You connect your own Xtream access or M3U playlists.',
    faq_2_q: 'How does the free trial work?',
    faq_2_a: '14 days to try the app. Then choose the yearly or lifetime plan.',
    faq_3_q: 'Which devices are supported?',
    faq_3_a: 'Android and Android TV. Download the APK or via Google Play when available.',
    faq_4_q: 'Can I watch offline?',
    faq_4_a: 'Yes, via local download on the device — depending on your playlist content.',
    faq_5_q: 'What is Watch Together?',
    faq_5_a: 'Synced remote playback: you watch the same stream at the same time.',
    faq_6_q: 'How can I contact you?',
    faq_6_a: 'Use the form below, or email contact@arich.fr.',

    contact_over: 'Contact',
    contact_title: 'Write to us',
    contact_sub: 'A question, a bug, feedback — we read everything.',
    contact_name: 'Name',
    contact_email: 'Email',
    contact_subject: 'Subject',
    contact_message: 'Message',
    contact_send: 'Send',
    contact_ok: 'Opening your mail client…',
